...
class Ad
{
    ...
    public function getAvgRatings()
    {
         ...
         * La fonction php array_reduce permet de réduire le tableau à une seule valeur (attention il faut un tableau
         * pas une arrat Collection, on va utiliser toArray() - 2ème paramètre c'est la fonction pour chaque valeur,
         * 3ème paramètre valeur par defaut)
         */
    ...
    public function getNotAvailableDays()
    {
        ...
        foreach($this->bookings as $booking) {
            ...
            // la function range() de php permet de créer un tableau qui contient chaque étape existante entre deux nombres
            // $result = range(10,20,2)
            // réponse: $resultat = [10,12,14,16,18,20]
